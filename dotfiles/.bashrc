...
alias ls='eza --icons --git --icons --sort newest'
alias ll='eza -al --git --icons --icons --sort newest'
alias la='eza -a --git --icons --icons --sort newest'
alias l='eza -l --git --icons --sort newest'
